package com.sam_chordas.android.stockhawk.data.persistent;
...
public class QuoteProvider {
  public static final String AUTHORITY = "com.sam_chordas.android.stockhawk.data.persistent.QuoteProvider";
